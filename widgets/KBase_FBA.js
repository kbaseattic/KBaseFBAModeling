function KBase_FBA(tabwidget) {
	...
	this.set_metadata = function (indata) {
		...
		this.overview.objective = indata[10]["Objective"];
		this.overview.model = indata[10]["Model"];		
		this.overview.media = indata[10]["Media"];
		this.overview.singleko = indata[10]["Combination deletions"];	
		this.overview.numreactions = indata[10]["Number reaction variables"];
		this.overview.numcompounds = indata[10]["Number compound variables"];
		this.overview.numgeneko = indata[10]["Number gene KO"];
		this.overview.numrxnko = indata[10]["Number reaction KO"];
		this.overview.numcpdbounds = indata[10]["Number compound bounds"];
		this.overview.numconstraints = indata[10]["Number constraints"];
		this.overview.numaddnlcpds = indata[10]["Number additional compounds"];
	};
