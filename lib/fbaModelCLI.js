...
function fbaModelCLI(url) {

    var _url = url;


    this.execute_command = function(args, stdin)
    {
	var resp = json_call_ajax_sync("fbaModelCLI.execute_command", [args, stdin]);
//	var resp = json_call_sync("fbaModelCLI.execute_command", [args, stdin]);
        return resp;
    }

    this.execute_command_async = function(args, stdin, _callback, _error_callback)
    {
	json_call_ajax_async("fbaModelCLI.execute_command", [args, stdin], 3, _callback, _error_callback)
    }
