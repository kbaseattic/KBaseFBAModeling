...
uniquely identifies a workspace among all workspaces.
    ...
    def get_gapfills(self, ctx, input):
        # ctx is the context object
    ...
    def get_gapgens(self, ctx, input):
        # ctx is the context object
    ...
    def get_aliassets(self, ctx, input):
        # ctx is the context object
    ...
    def get_biochemistry(self, ctx, input):
        # ctx is the context object
    ...
    def import_probanno(self, ctx, input):
        # ctx is the context object
    ...
    def genome_object_to_workspace(self, ctx, input):
        # ctx is the context object
    ...
    def genome_to_workspace(self, ctx, input):
        # ctx is the context object
        # return variables are: genomeMeta
    ...
    def domains_to_workspace(self, ctx, input):
        # ctx is the context object
    ...
    def compute_domains(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def add_feature_translation(self, ctx, input):
        # ctx is the context object
        # return variables are: genomeMeta
    ...
    def genome_to_fbamodel(self, ctx, input):
        # ctx is the context object
    ...
    def translate_fbamodel(self, ctx, input):
        # ctx is the context object
        # return variables are: modelMeta
    ...
    def build_pangenome(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def genome_heatmap_from_pangenome(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def ortholog_family_from_pangenome(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def pangenome_to_proteome_comparison(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def import_fbamodel(self, ctx, input):
        # ctx is the context object
        # return variables are: modelMeta
    ...
    def export_fbamodel(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def export_object(self, ctx, input):
        # ctx is the context object
        # return variables are: output
        #BEGIN export_object
        #END export_object
    ...
    def export_genome(self, ctx, input):
        # ctx is the context object
        # return variables are: output
        #BEGIN export_genome
        #END export_genome
    ...
    def adjust_model_reaction(self, ctx, input):
        # ctx is the context object
        # return variables are: modelMeta
    ...
    def adjust_biomass_reaction(self, ctx, input):
        # ctx is the context object
        # return variables are: modelMeta
    ...
    def export_media(self, ctx, input):
        # ctx is the context object
        # return variables are: output
        #BEGIN export_media
        #END export_media
    ...
    def quantitative_optimization(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def generate_model_stats(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def minimize_reactions(self, ctx, input):
        # ctx is the context object
        # return variables are: fbaMeta
    ...
    def import_phenotypes(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def simulate_phenotypes(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def add_media_transporters(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def export_phenotypeSimulationSet(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def integrate_reconciliation_solutions(self, ctx, input):
        # ctx is the context object
        # return variables are: modelMeta
    ...
    def queue_runfba(self, ctx, input):
        # ctx is the context object
    ...
    def queue_gapfill_model(self, ctx, input):
        # ctx is the context object
        # return variables are: job
    ...
    def queue_gapgen_model(self, ctx, input):
        # ctx is the context object
        # return variables are: job
    ...
    def gapgen_model(self, ctx, input):
        # ctx is the context object
        # return variables are: modelMeta
        #BEGIN gapgen_model
        #END gapgen_model
    ...
    def queue_wildtype_phenotype_reconciliation(self, ctx, input):
        # ctx is the context object
        # return variables are: job
    ...
    def queue_reconciliation_sensitivity_analysis(self, ctx, input):
        # ctx is the context object
        # return variables are: job
    ...
    def queue_combine_wildtype_phenotype_reconciliation(self, ctx, input):
        # ctx is the context object
        # return variables are: job
    ...
    def set_cofactors(self, ctx, input):
        # ctx is the context object
        # return variables are: output
        #BEGIN set_cofactors
        #END set_cofactors
    ...
    def find_reaction_synonyms(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def role_to_reactions(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def reaction_sensitivity_analysis(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def filter_iterative_solutions(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def delete_noncontributing_reactions(self, ctx, input):
        # ctx is the context object
        # return variables are: output
    ...
    def annotate_workspace_Genome(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def gtf_to_genome(self, ctx, params):
        # ctx is the context object
        # return variables are: output
        #BEGIN gtf_to_genome
        #END gtf_to_genome
    ...
    def fasta_to_ProteinSet(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def ProteinSet_to_Genome(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def fasta_to_ContigSet(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def ContigSet_to_Genome(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def probanno_to_genome(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def get_mapping(self, ctx, params):
        # ctx is the context object
        # return variables are: output
        #BEGIN get_mapping
        #END get_mapping
    ...
    def subsystem_of_roles(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def adjust_mapping_role(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def adjust_mapping_complex(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def adjust_mapping_subsystem(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def get_template_model(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def import_template_fbamodel(self, ctx, input):
        # ctx is the context object
        # return variables are: modelMeta
    ...
    def adjust_template_reaction(self, ctx, params):
        # ctx is the context object
        # return variables are: modelMeta
    ...
    def adjust_template_biomass(self, ctx, params):
        # ctx is the context object
        # return variables are: modelMeta
    ...
    def add_stimuli(self, ctx, params):
        # ctx is the context object
        # return variables are: output
        #BEGIN add_stimuli
        #END add_stimuli
    ...
    def import_regulatory_model(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def compare_models(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def compare_fbas(self, ctx, params):
        # ctx is the context object
        # return variables are: output
        #BEGIN compare_fbas
        #END compare_fbas
        ...
        # At some point might do deeper type checking...
        if not isinstance(output, list):
            raise ValueError('Method compare_fbas return value ' +
                             'output is not type list as required.')
        # return the results
        return [output]

    def compare_genomes(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def import_metagenome_annotation(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def models_to_community_model(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def metagenome_to_fbamodels(self, ctx, params):
        # ctx is the context object
    ...
    def import_expression(self, ctx, input):
        # ctx is the context object
    ...
    def import_regulome(self, ctx, input):
        # ctx is the context object
    ...
    def create_promconstraint(self, ctx, params):
        # ctx is the context object
    ...
    def add_biochemistry_compounds(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def update_object_references(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def add_reactions(self, ctx, params):
        # ctx is the context object
        # return variables are: output
        #BEGIN add_reactions
        #END add_reactions
    ...
    def remove_reactions(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def modify_reactions(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def add_features(self, ctx, params):
        # ctx is the context object
        # return variables are: output
        #BEGIN add_features
        #END add_features
    ...
    def remove_features(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def modify_features(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def import_trainingset(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def preload_trainingset(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def classify_genomes(self, ctx, params):
        # ctx is the context object
        # return variables are: output
    ...
    def build_tissue_model(self, ctx, params):
        # ctx is the context object
        # return variables are: output
