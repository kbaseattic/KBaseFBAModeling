...
function fbaModelServices(url, auth, auth_cb) {
    ...
    this.fasta_to_contigs = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.fasta_to_contigs", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.fasta_to_contigs", [params], 1, _callback, _error_callback)
    }

    this.contigs_to_genome = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.contigs_to_genome", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.contigs_to_genome", [params], 1, _callback, _error_callback)
    }

    this.get_mapping = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.get_mapping", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.get_mapping", [params], 1, _callback, _error_callback)
    }

    this.adjust_mapping_role = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.adjust_mapping_role", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.adjust_mapping_role", [params], 1, _callback, _error_callback)
    }

    this.adjust_mapping_complex = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.adjust_mapping_complex", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.adjust_mapping_complex", [params], 1, _callback, _error_callback)
    }

    this.adjust_mapping_subsystem = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.adjust_mapping_subsystem", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.adjust_mapping_subsystem", [params], 1, _callback, _error_callback)
    }

    this.get_template_model = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.get_template_model", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.get_template_model", [params], 1, _callback, _error_callback)
    }
    ...
    this.adjust_template_reaction = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.adjust_template_reaction", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.adjust_template_reaction", [params], 1, _callback, _error_callback)
    }

    this.adjust_template_biomass = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.adjust_template_biomass", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.adjust_template_biomass", [params], 1, _callback, _error_callback)
    }

    this.add_stimuli = function(params)
    {
        var resp = json_call_ajax_sync("fbaModelServices.add_stimuli", [params]);
    ...
    {
        json_call_ajax_async("fbaModelServices.add_stimuli", [params], 1, _callback, _error_callback)
    }
