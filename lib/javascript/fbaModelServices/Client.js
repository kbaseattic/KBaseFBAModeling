...
function fbaModelServices(url, auth, auth_cb) {
    ...
    this.compare_fbas = function (params, _callback, _errorCallback) {
    return json_call_ajax("fbaModelServices.compare_fbas",
        [params], 1, _callback, _errorCallback);
};

    this.compare_fbas_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("fbaModelServices.compare_fbas", [params], 1, _callback, _error_callback);
    };
