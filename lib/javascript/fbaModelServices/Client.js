...
function fbaModelServices(url, auth, auth_cb) {
    ...
    this.import_tintleprob = function (input, _callback, _errorCallback) {
    return json_call_ajax("fbaModelServices.import_tintleprob",
        [input], 1, _callback, _errorCallback);
};

    this.import_tintleprob_async = function (input, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("fbaModelServices.import_tintleprob", [input], 1, _callback, _error_callback);
    };
