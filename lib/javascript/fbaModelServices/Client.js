...
function fbaModelServices(url, auth, auth_cb) {
    ...
    this.genome_heatmap_from_pangenom = function (input, _callback, _errorCallback) {
    return json_call_ajax("fbaModelServices.genome_heatmap_from_pangenom",
        [input], 1, _callback, _errorCallback);
};

    this.genome_heatmap_from_pangenom_async = function (input, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("fbaModelServices.genome_heatmap_from_pangenom", [input], 1, _callback, _error_callback);
    };
