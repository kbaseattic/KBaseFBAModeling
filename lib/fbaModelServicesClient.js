...
//	var resp = json_call_sync("fbaModelServices.queue_wildtype_phenotype_reconciliation", [input]);
    ...
    this.queue_combine_wildtype_phenotype_reconciliation_params = function(input)
    {
	var resp = json_call_ajax_sync("fbaModelServices.queue_combine_wildtype_phenotype_reconciliation_params", [input]);
//	var resp = json_call_sync("fbaModelServices.queue_combine_wildtype_phenotype_reconciliation_params", [input]);
        return resp[0];
    }

    this.queue_combine_wildtype_phenotype_reconciliation_params_async = function(input, _callback, _error_callback)
    {
	json_call_ajax_async("fbaModelServices.queue_combine_wildtype_phenotype_reconciliation_params", [input], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("fbaModelServices.check_job", [input]);
    ...
    this.jobs_done = function(job)
    {
	var resp = json_call_ajax_sync("fbaModelServices.jobs_done", [job]);
//	var resp = json_call_sync("fbaModelServices.jobs_done", [job]);
        return resp[0];
    }

    this.jobs_done_async = function(job, _callback, _error_callback)
    {
	json_call_ajax_async("fbaModelServices.jobs_done", [job], 1, _callback, _error_callback)
    }
