package Bio::KBase::fbaModel::Data::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::fbaModel::Data::ServiceContext->new(client_ip => $self->_plack_req->address);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service fbaModelData.");
    }
...
package Bio::KBase::fbaModel::Data::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::fbaModel::Data::ServiceContext
