package Bio::KBase::fbaModelCLI::Server;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::fbaModelCLI::ServerContext->new(client_ip => $self->_plack_req->address);
...
package Bio::KBase::fbaModelCLI::ServerContext;

use strict;

=head1 NAME

Bio::KBase::fbaModelCLI::ServerContext
