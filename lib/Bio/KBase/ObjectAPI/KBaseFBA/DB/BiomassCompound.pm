########################################################################
# Bio::KBase::ObjectAPI::KBaseFBA::DB::BiomassCompound - This is the moose object corresponding to the KBaseFBA.BiomassCompound object
# Authors: Christopher Henry, Scott Devoid, Paul Frybarger
# Contact email: chenry@mcs.anl.gov
# Development location: Mathematics and Computer Science Division, Argonne National Lab
########################################################################
package Bio::KBase::ObjectAPI::KBaseFBA::DB::BiomassCompound;
...
# CONSTANTS:
sub _type { return 'KBaseFBA.BiomassCompound'; }
sub _module { return 'KBaseFBA'; }
sub _class { return 'BiomassCompound'; }
sub _top { return 0; }
