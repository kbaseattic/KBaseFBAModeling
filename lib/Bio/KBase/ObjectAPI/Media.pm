########################################################################
# Bio::KBase::ObjectAPI::Media - This is the moose object corresponding to the Media object
...
########################################################################
use strict;
use Bio::KBase::ObjectAPI::DB::Media;
package Bio::KBase::ObjectAPI::Media;
use Moose;
use namespace::autoclean;
use Bio::KBase::ObjectAPI::Util::utilities;
extends 'Bio::KBase::ObjectAPI::DB::Media';
#***********************************************************************************************************
...
Definition:
	string = Bio::KBase::ObjectAPI::Media->export({
...
Definition:
	string:Exchange format = Bio::KBase::ObjectAPI::Model->printExchange();
Description:
