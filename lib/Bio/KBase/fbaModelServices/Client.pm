...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function translate_fbamodel (received $n, expecting 1)");
    }
    {
	my($input) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method translate_fbamodel",
					    status_line => $self->{client}->status_line,
					    method_name => 'translate_fbamodel',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function pangenome_to_proteome_comparison (received $n, expecting 1)");
    }
    {
	my($input) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method pangenome_to_proteome_comparison",
					    status_line => $self->{client}->status_line,
					    method_name => 'pangenome_to_proteome_comparison',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function minimize_reactions (received $n, expecting 1)");
    }
    {
	my($input) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method minimize_reactions",
					    status_line => $self->{client}->status_line,
					    method_name => 'minimize_reactions',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function add_biochemistry_compounds (received $n, expecting 1)");
    }
    {
	my($params) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method add_biochemistry_compounds",
					    status_line => $self->{client}->status_line,
					    method_name => 'add_biochemistry_compounds',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function update_object_references (received $n, expecting 1)");
    }
    {
	my($params) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method update_object_references",
					    status_line => $self->{client}->status_line,
					    method_name => 'update_object_references',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function add_reactions (received $n, expecting 1)");
    }
    {
	my($params) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method add_reactions",
					    status_line => $self->{client}->status_line,
					    method_name => 'add_reactions',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function remove_reactions (received $n, expecting 1)");
    }
    {
	my($params) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method remove_reactions",
					    status_line => $self->{client}->status_line,
					    method_name => 'remove_reactions',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function modify_reactions (received $n, expecting 1)");
    }
    {
	my($params) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method modify_reactions",
					    status_line => $self->{client}->status_line,
					    method_name => 'modify_reactions',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function add_features (received $n, expecting 1)");
    }
    {
	my($params) = @args;
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function remove_features (received $n, expecting 1)");
    }
    {
	my($params) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method remove_features",
					    status_line => $self->{client}->status_line,
					    method_name => 'remove_features',
				       );
    }
...
# Authentication: required
    ...
    {
	Bio::KBase::Exceptions::ArgumentValidationError->throw(error =>
							       "Invalid argument count for function modify_features (received $n, expecting 1)");
    }
    {
	my($params) = @args;
	...
	if ($result->is_error) {
        ...
        Bio::KBase::Exceptions::HTTP->throw(error => "Error invoking method modify_features",
					    status_line => $self->{client}->status_line,
					    method_name => 'modify_features',
				       );
    }
