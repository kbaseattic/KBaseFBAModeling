...
#===============================================================================
#
#         FILE: gapfill_fbamodel.pl
#
#        USAGE: ./gapfill_fbamodel.pl [workspace] [model] [options]
#
#  DESCRIPTION: Queues a model for gapfilling.
#
#===============================================================================
use strict;
use warnings;
...
my $config = {
	...
	allowunbalanced => ["allowunbalanced","Allow any unbalanced reactions to be used in gapfilling",1,"formulation"],
	activitybonus => ["activitybonus:s","Add terms to objective favoring activation of inactive reactions",0,"formulation"],
	drainpen => ["drainpen:s","Penalty for gapfilling drain fluxes",1,"formulation"],
	directionpen => ["directionpen:s","Penalty for making irreversible reactions reverisble",1,"formulation"],
	nostructpen => ["nostructpen:s","Penalty for reactions involving a substrate with unknown structure",1,"formulation"],
	unfavorablepen => ["unfavorablepen:s","Penalty for thermodynamically unfavorable reactions",1,"formulation"],
	nodeltagpen => ["nodeltagpen:s","Penalty for reactions with unknown free energy change",1,"formulation"],
	biomasstranspen => ["biomasstranspen:s","Penalty for transporters involving biomass compounds",1,"formulation"],
	singletranspen => ["singletranspen:s","Penalty for transporters with only one reactant and product",1,"formulation"],	
	transpen => ["transpen:s","Penalty for gapfilling transport reactions",1,"formulation"],
	blacklistedrxns => ["blacklistedrxns:s@","List of reactions forbidden from gapfilling",[],"formulation"],
	gauranteedrxns => ["gauranteedrxns:s@","List of reactions gauranteed to be allowed in gapfilling",[],"formulation"],
	allowedcmps => ["allowedcmps:s@","List of compartments that may appear in gapfilling",[],"formulation"],
